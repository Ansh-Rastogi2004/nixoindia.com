# Generated by Django 4.0.6 on 2022-10-23 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('LO', 'Lotus'), ('RU', 'Rubino'), ('CR', 'Crystal'), ('CRG', 'Conti Rose Gold'), ('SQ', 'Squaro'), ('CL', 'Classic'), ('RE', 'Recta'), ('CU', 'Cubix'), ('AT', 'Atlanta'), ('HO', 'Hotelier'), ('RO', 'Rose'), ('MPS', 'Multipurpose Shelves'), ('CB', 'Conti Brass'), ('EC', 'Eco'), ('AL', 'Allied'), ('ESQ', 'Eco Squaro'), ('RUC', 'Rubino Chrome'), ('LOC', 'Lotus Chrome'), ('LUC', 'Luna Chrome')], max_length=3)),
